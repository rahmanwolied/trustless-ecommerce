...
const CREATE_CONNECTION_PROPS = {
  alias: "Reliabuy",
  goal: "To issue a Valid Reliabuy credential",
  goal_code: "issue-relibuy",
  my_label: "Reliabuy",
};
  ...
  return (
    <div className="flex flex-col items-center mb-6">
      ...
      <Button
        ...
        className="bg-gradient-to-r from-pink-500 to-violet-500 animate-pulse text-white transition-colors"
      >
        {isLoading ? (
